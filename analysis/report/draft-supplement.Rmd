...
#### Supplmentary Figure 2a: Second dose interval, where second dose vaccine is same as first dose vaccine

Second doses are censored by study end date, de-registration, death, and additionally by outcome-specific events.

```{r seconddose_same, echo=FALSE, message=FALSE, warning=FALSE, out.width='90%', fig.height=8, results='asis'}
read_rds(here("output", "descriptive", "seconddose", "plot_seconddose_samebrand.rds"))
```

#### Supplmentary Figure 2b: Second dose interval, where second dose vaccine is different than the first dose vaccine

Second doses are censored by study end date, de-registration, death, and additionally by outcome-specific events.

```{r seconddose_diff, echo=FALSE, message=FALSE, warning=FALSE, out.width='90%', fig.height=8, results='asis'}
read_rds(here("output", "descriptive", "seconddose", "plot_seconddose_diffbrand.rds"))
```
