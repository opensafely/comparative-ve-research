...
print_plots_cmlinc <- function(outcome, spline){

  
  calendar_curve <- read_rds(here("output", "models", outcome, "calendar", glue("reportplr_cmlinccurves_{spline}.rds"))) %>%
    mutate(timescale = "Calendar time")
  timesincevax_curve <- read_rds(here("output", "models", outcome, "timesincevax", glue("reportplr_cmlinccurves_{spline}.rds"))) %>%
    mutate(timescale = "Vaccinated time")
...
print_plots_cmlinc("emergency", "ns")
...
print_plots_cmlinc("covidadmitted", "ns")
