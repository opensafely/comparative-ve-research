...
```{r, curves, echo=FALSE, message=FALSE, out.width='90%'}

print_plots <- function(outcome, outcome_descr){
  km_image <- here("output", "descriptive", "km", glue("plot_survival_ci_{outcome}.png"))
  calendar_image <- here("output", outcome, "calendar", glue("forest_plot_cox.png"))
  timesincevax_image <- here("output", outcome, "timesincevax", glue("forest_plot_cox.png"))
  
  km_plot <- read_rds(here("output", "descriptive", "km", glue("plot_survival_ci_{outcome}.rds")))
  calendar_plot <- read_rds(here("output", outcome, "calendar", glue("forest_plot_cox.rds")))
  timesincevax_plot <- read_rds(here("output", outcome, "timesincevax", glue("forest_plot_cox.rds")))
  ...
  wrap_plot(
    km_plot+theme(legend.position = c(0.1,0.1), legend.justification = c(0,0)), 
    effects_plot, 
    ncol=1,
  ) + 
...
print_plots("emergency", "A&E attendances")
