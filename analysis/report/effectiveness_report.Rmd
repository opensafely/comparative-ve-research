...
print_plots_cmlinc <- function(outcome){

  
  calendar_curve <- read_rds(here("output", "models", outcome, "calendar", glue("reportplr_cmlinccurves_ns.rds"))) %>%
    mutate(timescale = "Calendar time")
  timesincevax_curve <- read_rds(here("output", "models", outcome, "timesincevax", glue("reportplr_cmlinccurves_ns.rds"))) %>%
    mutate(timescale = "Vaccinated time")
...
print_plots_cmlinc("covidadmitted")
